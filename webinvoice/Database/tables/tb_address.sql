...
CREATE TABLE `webinvoice`.`address` (
  ...
  CONSTRAINT `suburb_fk` FOREIGN KEY (`suburb`) REFERENCES `suburb` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
...
LOCK TABLES `webinvoice`.`address` WRITE;
...
-- Dump completed on 2013-05-09 13:28:54
